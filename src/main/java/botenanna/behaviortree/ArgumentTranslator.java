...
public class ArgumentTranslator {
    public static Function<Situation, Object> get(String key) throws UnknownBTKeyException {
        switch (key) {
            ...
            case "aim_pos": return (Situation a) -> a.getAimPosition();                      // Vector3
            ...
            case "my_goal_line_pos": return (Situation a) -> Arena.getGoalLinePos(a.myPlayerIndex);        // Vector3
            case "enemy_goal_line_pos": return (Situation a) -> Arena.getGoalLinePos(a.enemyPlayerIndex);  // Vector3
