...
public class Vector3 {
    ...
    /** Convert from flatbuffer to our Vector3. */
    public static Vector3 convert(rlbot.flat.Vector3 vec) {
        return new Vector3(vec.x(), vec.y(), vec.z());
    }

    /** Convert from a flatbuffer Rotator */
    public static Vector3 convert(rlbot.flat.Rotator rot) {
        return new Vector3(rot.roll(), rot.pitch(), rot.yaw());
    }
